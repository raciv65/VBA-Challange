Sub wall_streetMethod2()
 'Solving challange with WorksheetFunction  
 ...
 Dim TickerRange, YearChangeRange, PercentChangeRange, VolRange, GreatestIncrease, GreatestDecrease, GreatestVol as Range
...
Range("a1").CurrentRegion.Sort key1:=Range("a1"), Order1:=xlAscending, key2:=Range("b1"), Order2:=xlAscending, Header:=xlYes
    ...
    Set TickerRange = Range(Cells(2, lastColumn + 2), Cells(IntCount-1, lastColumn + 2))
    ...
    GreatestIncrease.Value = Application.WorksheetFunction.Max(PercentChangeRange)
    ...
    GreatestDecrease.Value = Application.WorksheetFunction.Min(PercentChangeRange)
    ...
    GreatestVol.Value = Application.WorksheetFunction.Max(VolRange)
